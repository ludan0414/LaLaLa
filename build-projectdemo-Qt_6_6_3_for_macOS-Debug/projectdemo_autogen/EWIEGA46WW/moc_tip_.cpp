...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASStip_ENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASStip_ENDCLASS_t qt_meta_stringdata_CLASStip_ENDCLASS = {
    {
        QT_MOC_LITERAL(0, 4)   // "tip_"
    },
    "tip_"
};
